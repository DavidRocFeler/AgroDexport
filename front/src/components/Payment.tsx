    ...
    <div className="bg-gray-100 min-h-screen flex items-center justify-center">
      <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-lg">
        <div className="flex items-center justify-between mb-6">
          ...
          <Image src="/logo.png" alt="Agro Dexports Logo" width={40} height={40} />
        </div>
        ...
        <div className="flex items-center mb-4">
          ...
          />
          <div className="ml-4">
            <h3 className="font-bold">Fruit </h3>
            <p className="text-sm text-gray-500">Quantity: 1  $40.00</p>
            <p className="text-sm text-gray-500">Delicious fruit  for a healthy lifestyle</p>
          </div>
        </div>
        <div className="mb-6">
