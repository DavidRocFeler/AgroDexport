    ...
    if (expandedOrderId !== orderId) {
      try {
        ...
        MySwal.fire({
          ...
          title: "Error",
          text:
            error.message || "No se pudieron cargar los detalles del producto.",
        });
      }
    } else {
              ...
              <div className="flex justify-between">
                ...
                <div>
                  <div>
                    ...
                    }).format(order.orderDetail.total)}
                  </div>
                </div>
              </div>
              ...
              {expandedOrderId === order.order_id && (
                <div className={Style.DivInfoComplete}>
                  <div className="flex justify-between">
                    <div>
                      <div>
                        <strong>Company Buy:</strong> {order.buyer.company_name}
                      </div>
                      <div>
                        <strong>Product Name:</strong>{" "}
                        {productDetails?.infoProduct.company_product_name}
                      </div>
                      <div>
                        <strong>Product Description:</strong>{" "}
                        {
                          productDetails?.infoProduct
                      ...
                      <div>
                        ...
                        {productDetails?.infoProduct.origin}
                      </div>
                      <div>
                        <strong>Price per kilogram:</strong>{" "}
                        {productDetails?.infoProduct.company_price_x_kg}
                      </div>
                    </div>
