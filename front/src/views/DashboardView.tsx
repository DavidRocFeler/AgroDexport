...
const DashboardView: React.FC = () => {
  ...
  return (
    ...
    //       {/* Second row -  Users and Products */}
    //       <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
    //         <div className="bg-white rounded-lg shadow p-6 h-[250px] overflow-auto">
    //           <AdminUserList />
    //         </div>
    //         <div className="bg-white rounded-lg shadow px-1 py-8 h-[250px] overflow-auto">
    //           <AdminCompanyList />
    //         </div>
    //       </div>
    ...
    //         <div className="col-span-2 bg-white rounded-lg shadow pt-12 h-[400px] overflow-auto">
    //           <AdminProductList />
    //         </div>
    //         <div className="bg-white rounded-lg shadow pt-0.5 h-[400px] overflow-auto">
    //           <AdminOrderList />
    //         </div>
    //       </div>
